...
alert("NEW VERSION LOADED");
    ...
    const students = [...document.querySelectorAll(".sg-student-link")]
        .map(link => {
...
<div class="sfBar">
    <button id="sfFlash">Flashcards</button>
    <button id="sfQuiz">Multiple Choice</button>
    <button id="sfType">Type Name</button>
    <button id="sfMatch">Matching</button>
    <button id="sfShuffle">Shuffle</button>
    <button id="sfClose">X</button>
</div>
...
`;
        ...
        const nameHeight =
            namesDiv.scrollHeight;


        namesDiv.style.height =
            nameHeight + "px";


        namesDiv.style.minHeight =
            nameHeight + "px";


        namesDiv.style.maxHeight =
            nameHeight + "px";
...
`;
        ...
        requestAnimationFrame(() => {
            ...
            const width =
                imagesDiv.clientWidth;


            const height =
                imagesDiv.clientHeight;
